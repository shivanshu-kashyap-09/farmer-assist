        ...
        {pestsData.map((pest, idx) => (
          <TouchableOpacity key={idx} style={styles.pestCard}>
            <View
              style={[
                styles.pestIcon,
                { backgroundColor: pest.severity === "High" ? "#fee4e2ff" : "#FEF3C7" },
              ]}
            >
              <Ionicons
                name="bug-outline"
                size={24}
                color={pest.severity === "High" ? "#e7cdcdff" : "#dbc8baff"}
              />
            </View>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#c4de78ff", padding: 16 },
  header: { alignItems: "center", marginBottom: 24 },
  headerIcon: {
    backgroundColor: "#69dc26ff",
    padding: 16,
    borderRadius: 50,
    marginBottom: 12,
  },
  ...
  uploadButton: {
    backgroundColor: "#69e962ff",
    paddingVertical: 10,
    paddingHorizontal: 12,
    borderRadius: 8,
  },
  uploadButtonText: { color: "#141313ff", fontWeight: "600" },

  predictionBox: { marginTop: 16, backgroundColor: "#a5ec61ff", padding: 12, borderRadius: 8 },
